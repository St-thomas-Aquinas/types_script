...
function perimenter(length, width) {
...
function Drive(firstName, Lastname, age) {
    console.log("Iam the function that is checking if you are old enough to drive");
    if (age >= 18) {
        console.log("Congratulation ".concat(firstName, " ").concat(Lastname));
    }
    else {
        console.log("sorry  ".concat(firstName, " ").concat(Lastname, " you are not old enough"));
    }
}
...
function findlargest(num1, num2, num3) {
    ...
    console.log("Between   ".concat(num1, " ").concat(num2, " ").concat(num3, " this is the largest ").concat(max, " "));
}
findlargest(100, 110, 10);
separator();
//End
//challenge 7: calculate body mass index
function calculateBM1(height, weight) {
    console.log("iam the function for calculating BMI");
    var BMI = weight / (height * height);
    if (BMI < 18.5) {
        console.log("your BMI IS   ".concat(BMI, " you are underweight} "));
    }
    else if (BMI == 18.5 || BMI <= 24.9) {
        console.log("your BMI IS   ".concat(BMI, " you are Normal weight} "));
    }
    else if (BMI == 25 || BMI <= 29.9) {
        console.log("your BMI IS  ".concat(BMI, " you are Overweight} "));
    }
    else if (BMI >= 30) {
        console.log("your BMI IS   ".concat(BMI, " you are obese} "));
    }
}
...
//End
//challenge 9: fizzbuz
function fizzbuzCheck(num) {
    console.log("Iam the function excuting challenge 9: fizzbuzcheck");
    var isDivisible3 = num % 3;
    var isDivisible5 = num % 5;
    if (isDivisible3 == 0) {
...
function perimenter2(shape, num) {
    if ((shape = "s")) {
